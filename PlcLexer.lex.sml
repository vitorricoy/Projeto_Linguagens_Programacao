...
| 28 => (DIFF(yypos, yypos))
| 30 => (LESS(yypos, yypos))
| 33 => (LESSEQ(yypos, yypos))
| 36 => (DOUBLECOLON(yypos, yypos))
| 38 => (SEMICOLON(yypos, yypos))
| 4 => (lex())
| 40 => (LPAR(yypos, yypos))
| 42 => (RPAR(yypos, yypos))
| 44 => (LBRACK(yypos, yypos))
| 46 => (RBRACK(yypos, yypos))
| 48 => (LBRACE(yypos, yypos))
| 50 => (RBRACE(yypos, yypos))
